...
module AvalaraSdk::A1099
  module AvalaraSdk::A1099::V2
    class TINMatchesApi
      ...
      def perform_real_time_tin_match(request_parameters)
        data, _status_code, _headers = perform_real_time_tin_match_with_http_info(request_parameters)
        data
      end
      ...
      # @param real_time_tin_match_request [RealTimeTinMatchRequest] Required data to perform TIN match    
      # @return [Array<(RealTimeTinMatchResponse, Integer, Hash)>] RealTimeTinMatchResponse data, response status code and response headers
      def perform_real_time_tin_match_with_http_info(request_parameters)
        # OAuth2 Scopes
        required_scopes = ''
        # Request Parameters
        ...
        real_time_tin_match_request = request_parameters.get_real_time_tin_match_request()
        # verify the required parameter 'avalara_version' is set
        if @api_client.config.client_side_validation && avalara_version.nil?
          fail ArgumentError, "Missing the required parameter 'avalara_version' when calling TINMatchesApi.perform_real_time_tin_match"
        end
        # resource path
        local_var_path = '/tin-matches/$real-time'
        ...
        # http body (model)
        post_body =  @api_client.object_to_http_body(real_time_tin_match_request) || {}

        # return_type
        return_type = 'RealTimeTinMatchResponse'
        ...
        new_options = {
          :operation => :"TINMatchesApi.perform_real_time_tin_match",
    ...
    # @param  RealTimeTinMatchRequest $real_time_tin_match_request Required data to perform TIN match (optional)
    #
    class PerformRealTimeTinMatchRequestSdk
        ...
        attr_accessor :real_time_tin_match_request
        ...
        def get_real_time_tin_match_request()
            return @real_time_tin_match_request
        end
