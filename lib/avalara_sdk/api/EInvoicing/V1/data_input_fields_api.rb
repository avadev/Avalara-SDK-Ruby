    ...
    class DataInputFieldsApi
      ...
      def get_data_input_fields_with_http_info(request_parameters)
        ...
        if @api_client.config.client_side_validation && avalara_version.nil?
          fail ArgumentError, "Missing the required parameter 'avalara_version' when calling DataInputFieldsApi.get_data_input_fields"
        end
        # resource path
        local_var_path = '/einvoicing/data-input-fields'
        ...
        # return_type
        return_type = 'DataInputFieldsResponse'
        ...
        new_options = {
          :operation => :"DataInputFieldsApi.get_data_input_fields",
