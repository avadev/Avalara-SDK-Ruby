  ...
  module AvalaraSdk::A1099::V2
    class CompaniesW9Api
      ...
      def create_company_with_http_info(request_parameters)
        ...
        new_options = {
          :operation => :"CompaniesW9Api.create_company",
      ...
      def delete_company_with_http_info(request_parameters)
        ...
        new_options = {
          :operation => :"CompaniesW9Api.delete_company",
          :header_params => header_params,
          :query_params => query_params,
          :form_params => form_params,
          :body => post_body,
      ...
      def get_companies_with_http_info(request_parameters)
        ...
        # return_type
        return_type = 'PaginatedQueryResultModelCompanyResponse'
        ...
        new_options = {
          :operation => :"CompaniesW9Api.get_companies",
          :header_params => header_params,
          :query_params => query_params,
          :form_params => form_params,
          :body => post_body,
      ...
      def get_company_with_http_info(request_parameters)
        ...
        new_options = {
          :operation => :"CompaniesW9Api.get_company",
          :header_params => header_params,
          :query_params => query_params,
          :form_params => form_params,
          :body => post_body,
      ...
      def update_company_with_http_info(request_parameters)
        ...
        new_options = {
          :operation => :"CompaniesW9Api.update_company",
          :header_params => header_params,
          :query_params => query_params,
          :form_params => form_params,
          :body => post_body,
